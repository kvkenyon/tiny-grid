...
```python
from pyercot.models import MyDataModel
from pyercot.api.my_tag import get_my_data_model
from pyercot.types import Response
...
1. Any endpoint which did not have a tag will be in `pyercot.api.default`
