...
def _get_kwargs(
    *,
    total_self_arranged_asrrsufr_from: float | Unset = UNSET,
    total_self_arranged_asrrsufr_to: float | Unset = UNSET,
    ...
    total_self_arranged_asregup_from: float | Unset = UNSET,
    total_self_arranged_asregup_to: float | Unset = UNSET,
    total_self_arranged_asregdn_from: float | Unset = UNSET,
    total_self_arranged_asregdn_to: float | Unset = UNSET,
    total_self_arranged_asnspin_from: float | Unset = UNSET,
    total_self_arranged_asnspin_to: float | Unset = UNSET,
    total_self_arranged_asnspnm_from: float | Unset = UNSET,
    total_self_arranged_asnspnm_to: float | Unset = UNSET,
    total_self_arranged_asrrspfr_from: float | Unset = UNSET,
    total_self_arranged_asrrspfr_to: float | Unset = UNSET,
    total_self_arranged_asrrsffr_from: float | Unset = UNSET,
    total_self_arranged_asrrsffr_to: float | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        total_self_arranged_asrrsufr_from (float | Unset):
        total_self_arranged_asrrsufr_to (float | Unset):
        delivery_date_from (str | Unset):
        delivery_date_to (str | Unset):
        hour_ending_from (int | Unset):
        hour_ending_to (int | Unset):
        qse_name (str | Unset):
        total_self_arranged_asregup_from (float | Unset):
        total_self_arranged_asregup_to (float | Unset):
        total_self_arranged_asregdn_from (float | Unset):
        total_self_arranged_asregdn_to (float | Unset):
        total_self_arranged_asnspin_from (float | Unset):
        total_self_arranged_asnspin_to (float | Unset):
        total_self_arranged_asnspnm_from (float | Unset):
        total_self_arranged_asnspnm_to (float | Unset):
        total_self_arranged_asrrspfr_from (float | Unset):
        total_self_arranged_asrrspfr_to (float | Unset):
        total_self_arranged_asrrsffr_from (float | Unset):
        total_self_arranged_asrrsffr_to (float | Unset):
        page (int | Unset):
        size (int | Unset):
        sort (str | Unset):
        dir_ (str | Unset):
