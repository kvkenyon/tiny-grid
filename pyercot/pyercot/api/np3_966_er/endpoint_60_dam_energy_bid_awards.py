...
def _get_kwargs(
    *,
    ...
    energy_only_bid_award_in_mw_from: float | Unset = UNSET,
    energy_only_bid_award_in_mw_to: float | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        qse_name (str | Unset):
        energy_only_bid_award_in_mw_from (float | Unset):
        energy_only_bid_award_in_mw_to (float | Unset):
