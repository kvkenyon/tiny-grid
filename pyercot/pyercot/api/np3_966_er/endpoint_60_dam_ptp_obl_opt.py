...
def _get_kwargs(
    *,
    ...
    price_from: int | Unset = UNSET,
    price_to: int | Unset = UNSET,
    offer_id: str | Unset = UNSET,
    multi_hour_block: bool | Unset = UNSET,
    crr_id_from: int | Unset = UNSET,
    crr_id_to: int | Unset = UNSET,
    ...
    params["CRRIdFrom"] = crr_id_from

    params["CRRIdTo"] = crr_id_to
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        mw_from (float | Unset):
        mw_to (float | Unset):
        price_from (int | Unset):
        price_to (int | Unset):
        offer_id (str | Unset):
        multi_hour_block (bool | Unset):
        crr_id_from (int | Unset):
        crr_id_to (int | Unset):
        page (int | Unset):
        size (int | Unset):
        sort (str | Unset):
