...
def _get_kwargs(
    *,
    ...
    total_cleared_asrrsffr_from: float | Unset = UNSET,
    total_cleared_asrrsffr_to: float | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        total_cleared_asrrsffr_from (float | Unset):
        total_cleared_asrrsffr_to (float | Unset):
        page (int | Unset):
        size (int | Unset):
        sort (str | Unset):
        dir_ (str | Unset):
