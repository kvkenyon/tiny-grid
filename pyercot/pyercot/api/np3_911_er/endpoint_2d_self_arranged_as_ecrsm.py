...
def _get_kwargs(
    *,
    ...
    total_self_arranged_asecrsm_from: float | Unset = UNSET,
    total_self_arranged_asecrsm_to: float | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        total_self_arranged_asecrsm_from (float | Unset):
        total_self_arranged_asecrsm_to (float | Unset):
        page (int | Unset):
        size (int | Unset):
        sort (str | Unset):
        dir_ (str | Unset):
