...
def _get_kwargs(
    *,
    ...
    spp_original_from: float | Unset = UNSET,
    spp_original_to: float | Unset = UNSET,
    spp_corrected_from: float | Unset = UNSET,
    spp_corrected_to: float | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        spp_original_from (float | Unset):
        spp_original_to (float | Unset):
        spp_corrected_from (float | Unset):
        spp_corrected_to (float | Unset):
        page (int | Unset):
        size (int | Unset):
        sort (str | Unset):
        dir_ (str | Unset):
