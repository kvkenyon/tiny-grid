...
def _get_kwargs(
    *,
    ...
    sum_lsl_output_sched_from: float | Unset = UNSET,
    sum_lsl_output_sched_to: float | Unset = UNSET,
    sum_hsl_output_sched_from: float | Unset = UNSET,
    sum_hsl_output_sched_to: float | Unset = UNSET,
    sum_output_sched_from: float | Unset = UNSET,
    sum_output_sched_to: float | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sum_lsl_output_sched_from (float | Unset):
        sum_lsl_output_sched_to (float | Unset):
        sum_hsl_output_sched_from (float | Unset):
        sum_hsl_output_sched_to (float | Unset):
        sum_output_sched_from (float | Unset):
        sum_output_sched_to (float | Unset):
        page (int | Unset):
        size (int | Unset):
        sort (str | Unset):
        dir_ (str | Unset):
