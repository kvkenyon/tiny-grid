...
def _get_kwargs(
    *,
    ...
    sum_base_point_non_irr_from: float | Unset = UNSET,
    sum_base_point_non_irr_to: float | Unset = UNSET,
    sum_hasl_non_irr_from: float | Unset = UNSET,
    sum_hasl_non_irr_to: float | Unset = UNSET,
    sum_lasl_non_irr_from: float | Unset = UNSET,
    sum_lasl_non_irr_to: float | Unset = UNSET,
    sum_base_point_wgr_from: float | Unset = UNSET,
    sum_base_point_wgr_to: float | Unset = UNSET,
    sum_haslwgr_from: float | Unset = UNSET,
    sum_haslwgr_to: float | Unset = UNSET,
    sum_laslwgr_from: float | Unset = UNSET,
    sum_laslwgr_to: float | Unset = UNSET,
    sum_base_point_pvgr_from: float | Unset = UNSET,
    sum_base_point_pvgr_to: float | Unset = UNSET,
    sum_haslpvgr_from: float | Unset = UNSET,
    sum_haslpvgr_to: float | Unset = UNSET,
    sum_laslpvgr_from: float | Unset = UNSET,
    sum_laslpvgr_to: float | Unset = UNSET,
    sum_base_point_remres_from: float | Unset = UNSET,
    sum_base_point_remres_to: float | Unset = UNSET,
    sum_haslremres_from: float | Unset = UNSET,
    sum_haslremres_to: float | Unset = UNSET,
    sum_laslremres_from: float | Unset = UNSET,
    sum_laslremres_to: float | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sum_base_point_non_irr_from (float | Unset):
        sum_base_point_non_irr_to (float | Unset):
        sum_hasl_non_irr_from (float | Unset):
        sum_hasl_non_irr_to (float | Unset):
        sum_lasl_non_irr_from (float | Unset):
        sum_lasl_non_irr_to (float | Unset):
        sum_base_point_wgr_from (float | Unset):
        sum_base_point_wgr_to (float | Unset):
        sum_haslwgr_from (float | Unset):
        sum_haslwgr_to (float | Unset):
        sum_laslwgr_from (float | Unset):
        sum_laslwgr_to (float | Unset):
        sum_base_point_pvgr_from (float | Unset):
        sum_base_point_pvgr_to (float | Unset):
        sum_haslpvgr_from (float | Unset):
        sum_haslpvgr_to (float | Unset):
        sum_laslpvgr_from (float | Unset):
        sum_laslpvgr_to (float | Unset):
        sum_base_point_remres_from (float | Unset):
        sum_base_point_remres_to (float | Unset):
        sum_haslremres_from (float | Unset):
        sum_haslremres_to (float | Unset):
        sum_laslremres_from (float | Unset):
        sum_laslremres_to (float | Unset):
