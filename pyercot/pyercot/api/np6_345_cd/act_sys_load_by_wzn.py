...
def _get_kwargs(
    *,
    ...
    north_c_from: float | Unset = UNSET,
    north_c_to: float | Unset = UNSET,
    southern_from: float | Unset = UNSET,
    southern_to: float | Unset = UNSET,
    south_c_from: float | Unset = UNSET,
    south_c_to: float | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        north_c_from (float | Unset):
        north_c_to (float | Unset):
        southern_from (float | Unset):
        southern_to (float | Unset):
        south_c_from (float | Unset):
        south_c_to (float | Unset):
