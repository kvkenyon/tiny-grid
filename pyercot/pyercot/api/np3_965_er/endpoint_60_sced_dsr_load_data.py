...
def _get_kwargs(
    *,
    ...
    total_telemetered_dsr_loads_from: float | Unset = UNSET,
    total_telemetered_dsr_loads_to: float | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        qse_name (str | Unset):
        total_telemetered_dsr_loads_from (float | Unset):
        total_telemetered_dsr_loads_to (float | Unset):
